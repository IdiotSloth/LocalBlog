...
**Constitution 铁律 (T2406 追加)**: persistence leakage / orphan runtime / hidden accumulation / unilateral persistence → Constitution-level violation。**不得延后到 Stage B**，必须立即修复。观测期内状态机继续写入 = 观测无效。
