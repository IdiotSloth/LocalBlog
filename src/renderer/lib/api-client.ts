...
const webApi = {
  ...
  tagMerge: () => Promise.resolve({ success: false, error: '网页版暂不支持标签合并' }),
  ...
  blogSetPinned: () => Promise.resolve({ success: false, error: '网页版暂不支持此操作' }),
  blogSetColor: () => Promise.resolve({ success: false, error: '网页版暂不支持此操作' }),
  ...
  kbUpdateContent: () => Promise.resolve({ success: false, error: '网页版暂不支持编辑文件内容' }),
