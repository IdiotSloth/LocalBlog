  ...
  return (
    <div>
      ...
      {searchOpen && (
        ...
        >
          <div
            className="w-full max-w-[420px] rounded-[8px] border p-4 shadow-2xl"
          ...
          >
            <div className="mb-3 flex items-center justify-between">
              ...
              <button type="button" onClick={() => setSearchOpen(false)} style={{ color: 'var(--text-secondary)' }}>
                ✕
              </button>
            </div>
            ...
            <div className="max-h-[240px] overflow-y-auto space-y-1">
              ...
              {query && results.length === 0 && (
                <p className="text-center text-[12px] py-3" style={{ color: 'var(--text-secondary)' }}>
                  未找到匹配项
                </p>
              )}
            </div>
