...
│  │ Node.js  │  114 个通道     │ Vite 7 + Tailwind │ │
│  └────┬─────┘                   └────────┬─────────┘ │
│       │                                  │            │
│       │  ┌────────────────────┐          │            │
│       └─►│ MySQL 8.3 (主)      │◄─────────┘            │
...
- **Phase 1-20**: ✅ 全部完成
  - Phase 20 18/18：3栏布局/[[双向链接]]/知识图谱/今日中枢/AI接入/设计语言重塑 — 核心功能全部交付
  ...
  - `noUncheckedIndexedAccess` 永久启用。renderer `: any` 0。`as any` renderer=0。IPC 114 (+2: graph:getData)。
- **审查修复**: 累计 ~135 项修复 (F01-F135+), 224 个工单 (R01-R224), 62 个决策点 (D01-D62)
- **当前待修复**: 🔴0 🟠0 🟡0 🟢0 — 阻断项全零。P2/P3 开放项延 Phase 21 收尾
- **已知缺口**: 国际化 i18n (D18=C 否决); 阅读主题 sepia 对比度 (R217); 图谱键盘可访问性 (R216)
